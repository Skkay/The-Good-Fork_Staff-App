...
import BarmanOrderDrinkContentItem from './BarmanOrderDrinkContentItem';
import BarmanOrderMenuContentItem from './BarmanOrderMenuContentItem';

const BarmanOrderItem = ({ order, handleUpdateStatusOrder }) => {
          ...
          {order.orderedMenu.length !== 0 && (
            <View style={styles.orderContentGroup}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => <BarmanOrderMenuContentItem item={item} />}
          ...
          {order.orderedDrink.length !== 0 && (
            <View style={styles.orderContentGroup}>
              ...
              <FlatList
                ...
                renderItem={({ item }) => <BarmanOrderDrinkContentItem item={item} />}
...
export default BarmanOrderItem;
