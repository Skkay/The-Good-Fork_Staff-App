...
const FinishedOrdersScreen = () => {
  ...
  const handleReturnOrder = (orderId) => {
    updateOrderStatus(token, orderId, 5)
      .then((res) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      {selectedTab === 0 && (
        ...
        <FlatList
            data={eatInOrders}
            renderItem={({ item }) => <OrderItem order={item} handleValidateOrder={handleReturnOrder} handleCancelOrder={handleCancelOrder} />}
...
export default FinishedOrdersScreen;
